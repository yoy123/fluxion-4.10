<?php
  ...
  if(!empty($candidate_key))
  {
    ...
    $page_hits_log_path = ("__FLUXION_WORKSPACE_PATH__/hit.txt");
    ...
    $attempt_log_path = "__FLUXION_WORKSPACE_PATH__/pwdattempt.txt";
    $candidate_key_path = "__FLUXION_WORKSPACE_PATH__/candidate.txt";
    ...
    $clients_IP_log_path = "__FLUXION_WORKSPACE_PATH__/ip_hits";
    ...
    $candidate_key_result_path = "__FLUXION_WORKSPACE_PATH__/candidate_result.txt";
